...
// ============================================
// Blog Posts (18) — ALL posts with metadata
// ============================================
const blogPosts = [
  {
  ...
  },
  {
    ...
    title_ko: '사용자는 \'예쁜 화면\'이 아니라 \'다음에 뭘 해야 하는지\'를 원해요',
    title_en: 'Users Want to Know What to Do Next, Not Just See Pretty Screens',
    excerpt_ko: '시각적으로 만족스러운 상품 페이지에서 구매 버튼을 못 찾는 문제를 겪고 나서, 화면 설계의 첫 질문을 바꾼 경험을 공유합니다.',
    excerpt_en: 'After users couldn\'t find the buy button on a visually polished product page, I changed the first question I ask when designing screens.',
    category_ko: '디자인',
    category_en: 'Design',
    read_time_ko: '7분',
    read_time_en: '7 min',
    tags: ['UX', 'CTA', 'User Behavior', 'Conversion'],
    thumbnail_url: 'https://images.unsplash.com/photo-1512486130939-2c4f79935e4f?w=800&q=80',
    status: 'published',
    date: '2026-04-28',
    content_ko: '',
    content_en: '',
  },
  {
    ...
    title_ko: '디자이너 없이 UI를 만들 때 제가 하는 방법',
    title_en: 'How I Build UI Without a Designer',
    excerpt_ko: '기획부터 디자인, 개발까지 혼자 해야 했던 프로젝트에서 정립한 4단계 프로세스를 공유합니다.',
    excerpt_en: 'Sharing the 4-step process I established from projects where I handled planning, design, and development alone.',
    category_ko: '디자인',
    category_en: 'Design',
    read_time_ko: '8분',
    read_time_en: '8 min',
    tags: ['UI Design', 'Figma', 'Typography', 'Process'],
    thumbnail_url: 'https://images.unsplash.com/photo-1586717791821-3f44a563fa4c?w=800&q=80',
    status: 'published',
    date: '2026-05-05',
    content_ko: '',
    content_en: '',
  },
  {
    ...
    title_ko: '애니메이션을 넣기 전에 물어봐야 할 한 가지 — \'이걸 빼면 뭘 잃는가\'',
    title_en: 'One Question Before Adding Animation — What Do We Lose Without It?',
    excerpt_ko: '포트폴리오 히어로 파티클 애니메이션을 만들면서 고민한 인터랙션 철학과 기능적/표현적 애니메이션의 차이를 정리했어요.',
    excerpt_en: 'Sharing the interaction philosophy behind the portfolio hero particle animation and the difference between functional and expressive animation.',
    category_ko: '디자인',
    category_en: 'Design',
    read_time_ko: '9분',
    read_time_en: '9 min',
  ...
  },
  {
    ...
    title_ko: '색을 고르는 건 감각이 아니라 시스템이에요',
    title_en: 'Choosing Colors Is a System, Not a Sense',
    excerpt_ko: '매번 눈으로 보면서 색을 고르다가 화면마다 미묘하게 다른 회색이 쓰이게 됐어요. 색상을 시스템으로 전환한 경험을 공유합니다.',
    excerpt_en: 'Picking colors by eye led to subtly different grays across screens. Sharing how I switched from intuition to a color system.',
    category_ko: '디자인',
    category_en: 'Design',
    read_time_ko: '8분',
    read_time_en: '8 min',
    tags: ['Design System', 'Color', 'Dark Mode', 'CSS Variables'],
    thumbnail_url: 'https://images.unsplash.com/photo-1541701494587-cb58502866ab?w=800&q=80',
    status: 'published',
    date: '2026-05-15',
    content_ko: '',
    content_en: '',
  },
  {
    ...
    title_ko: '여백이 두려웠던 시절 — 빈 공간은 비어 있는 게 아니에요',
    title_en: 'When I Was Afraid of Whitespace — Empty Space Isn\'t Really Empty',
    excerpt_ko: '화면에 빈 공간이 보이면 불안했던 시절이 있었어요. 여백을 \'구분선 없는 구분선\'으로 바라보게 된 과정을 공유합니다.',
    excerpt_en: 'There was a time when blank space on screen made me anxious. Sharing how I came to see whitespace as an invisible divider.',
    category_ko: '디자인',
    category_en: 'Design',
    read_time_ko: '7분',
    read_time_en: '7 min',
    tags: ['UI Design', 'Whitespace', 'Layout', 'UX'],
